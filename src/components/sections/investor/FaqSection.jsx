    ...
    const faqs = [
        {
            ...
            answer: "We offer a wide range of grooming, cleaning, and pet care services to ensure your pets are happy and healthy.",
        },
        {
            id: 2,
            question: "How can I book an appointment?",
            answer: "You can book an appointment directly through our website or contact us via phone or email.",
        },
        {
            id: 3,
            question: "Do you offer home services?",
            answer: "Yes, we provide home grooming and cleaning services in select areas. Please check with us for availability.",
        },
        {
            id: 4,
            question: "What are your working hours?",
            answer: "Our services are available Monday to Saturday, from 9 AM to 6 PM.",
        },
        {
            id: 5,
            question: "Are your products safe for pets?",
            answer: "Absolutely! All our products are carefully selected to be safe and gentle for pets.",
        },
    ];
