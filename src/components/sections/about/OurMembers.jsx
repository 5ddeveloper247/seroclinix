...
export default function OurMembers() {
    const { data } = useSelector((state) => state.about); // assuming 'about' slice holds API data
        ...
        <section>
            <div className="wrapper py-15 lg:py-[6vw]">
                ...
                <div className="text-center mb-10 lg:mb-[4vw] lg:max-w-[50vw] mx-auto">
                    <h2 className="font-pat leading-none mb-10 text-primary">Our Members</h2>
                            ...
                            <div className="relative w-full aspect-[1.3/1] mb-4">
                                <Image
                                    src={
                                        member.image
                                            ? member.image
                                            : "/images/default-member.jpg" // fallback image if API image is null
                                    }
                                    alt={member.name}
                                    fill
