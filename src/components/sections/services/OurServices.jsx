...
const SideBar = ({
  ...
  <div className="flex flex-col gap-7 lg:gap-[1.5vw] max-h-[85vh] overflow-auto sticky top-[20%] p-7 lg:p-0">
    ...
    >
      <ul className="space-y-2">
        <li
          ...
          className={`cursor-pointer px-4 py-2 text-[14px] lg:text-[1vw] rounded-full ${!selectedCategory ? "border border-footer text-footer" : "bg-[#F6F6F6]"}`}
        >
          All
        </li>
        {categories.map((cat) => (
          <li
            ...
            className={`cursor-pointer px-4 py-2 text-[14px] lg:text-[1vw] rounded-full ${selectedCategory === cat ? "border border-footer text-footer" : "bg-[#F6F6F6]"}`}
          >
            {cat}
          </li>
        ))}
    ...
    >
      <ul className="space-y-2">
        <li
          ...
          className={`cursor-pointer px-4 py-2 text-[14px] lg:text-[1vw] rounded-full ${!selectedSubcategory ? "border border-footer text-footer" : "bg-[#F6F6F6]"}`}
        >
          All
        </li>
        {subcategories.map((sub) => (
          <li
            ...
            className={`cursor-pointer px-4 py-2 text-[14px] lg:text-[1vw] rounded-full ${selectedSubcategory === sub ? "border border-footer text-footer" : "bg-[#F6F6F6]"}`}
          >
            {sub}
          </li>
        ))}
    ...
    <Button 
      ...
      className="text-footer! border-2 text-[14px] lg:text-[1vw] border-footer! bg-white flex justify-center items-center py-[.3vw] px-[.7vw] w-full"
    />
  </div>
);
