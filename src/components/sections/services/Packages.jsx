...
export default function Packages() {
    ...
    const showSkeleton = loading || !pricingPlans.length;

    return (
        <section
            className="h-fit w-full relative bg-center bg-cover"
            style={{ backgroundImage: "url('/images/package/package.jpg')" }}
        >
            ...
            <div className="relative z-90 wrapper">
                <div className="py-20 flex flex-col items-center justify-center">
                    <div className="text-center lg:w-1/2 mb-10 lg:mb-0">
                        ...
                        <h2 className="text-white mb-5! lg:mb-0!">
                            Pet’s grooming services & pricing.
                        </h2>
                        <p className="text-white opacity-100">
                            We pride ourselves on offering personalized attention tailored to
                            meet the unique needs of each pet. Our state-of-the-art
                            facilities are equipped with the latest technology to deliver.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[2vw] w-full">
                        {showSkeleton
                            ? Array.from({ length: 3 }).map((_, index) => (
                                <div
                                    key={index}
                                    className="bg-white p-7 lg:p-[2vw] rounded-2xl lg:rounded-[1vw] w-full"
                                >
                                    <Skeleton className="w-15 h-15 lg:w-[4vw] lg:h-[4vw] mx-auto mb-4 rounded-full" />
                            ...
                            : pricingPlans.map((plan, index) => (
                                ...
                                >
                                    ...
                                    {/* Description */}
                                    <p className="text-center opacity-100 font-medium">
                                        {plan.description}
                                    </p>
